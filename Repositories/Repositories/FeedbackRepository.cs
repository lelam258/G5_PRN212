...
namespace Repositories.Repositories
{
    public class FeedbackRepository : IFeedbackRepository
    {
        ...
        public List<Feedback> GetFeedbacksByCourse(int courseId) => _feedbackDAO.GetFeedbacksByCourse(courseId);

        public List<Feedback> GetFeedbacksByMonth(int month, int year) => _feedbackDAO.GetFeedbacksByMonth(month, year);
    }
}